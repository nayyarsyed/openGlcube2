 ...
 */
package com.example.openglcube2;
...
public class MainActivity extends Activity {
    ...
    public class DemoRenderer implements Renderer {
        ...
        public void onSurfaceChanged(GL10 gl, int width, int height) {
            ...
            GLU.gluPerspective(gl, 40.10f, (float) width / (float) height, 0.1f, 100.0f);
        ...
        public void onDrawFrame(GL10 gl) {
            ...
            gl.glRotatef(rotation, 10.0f, 1.0f, 1.0f);
            cube.draw(gl);
            gl.glTranslatef(0.f, 0.0f, -10.0f);
            cube2.draw(gl);
            gl.glTranslatef(0.f, 0.0f, -10.0f);
            cube2.draw(gl);
            gl.glRotatex(10,20,20,30);
            gl.glTranslatef(0.f, 0.0f, -10.0f);
            cube2.draw(gl);
          //  gl.glLoadIdentity();
            rotation -= 0.95f;
